          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            >
              ...
              <h2 className="text-display text-slate/60 mt-1">
                A business intelligence profile.
              </h2>
              <p className="mt-5 text-base text-slate leading-relaxed max-w-[36ch]">
                Every business on LINKSUPPLIED has a structured profile
                showing what they make, their capacity, certifications,
                markets, and verified credentials.
              </p>
              <Link
                href="/discover"
                className="inline-flex items-center gap-2 mt-6 text-sm font-medium text-copper hover:text-copper-muted transition-colors"
              >
                See it in action
                <ArrowRight size={14} />
              </Link>
                ...
                <div className="p-6 md:p-8 space-y-6">
                  ...
                  <div ref={capabilityGridRef} className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <IntelField
                      icon={<Globe size={14} />}
                      label="Markets"
                      value={`${company.marketsServed.length} regions`}
                    />
                    <IntelField
                  ...
                  {/* Verification status */}
                  <div>
                    <span ref={verificationLabelRef} className="text-mono-label text-slate/50 block mb-2.5 text-[10px]">
                      VERIFICATION
                    </span>
                    <div ref={badgesListRef} className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {company.verification.slice(0, showDeep ? undefined : 3).map((v) => (
