...
const SIGNALS: SignalData[] = [
  {
    ...
    name: "PRODUCT FIT",
    score: 95,
    metric: "Glass cosmetic bottles",
    proof: "Exact product category match",
  },
  {
    id: "capacity",
    name: "CAPACITY",
    ...
    proof: "Requirement: 50,000 units / month",
  },
  {
    id: "certifications",
    name: "CERTIFICATIONS",
    ...
    proof: "Active registry verified through 2027",
  },
];
      ...
      <section className="py-24 bg-paper">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-base text-slate max-w-xl mx-auto mb-10">
            LINKSUPPLIED doesn&apos;t just rank a business. It shows the signals behind the match.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            {SIGNALS.map((sig) => (
              <div
                key={sig.id}
                className="bg-surface rounded-xl p-4 border border-ink/[0.08]"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-mono uppercase text-slate/80 font-bold">
                    {sig.name}
                  </span>
                ...
                <p className="text-sm font-semibold text-ink">{sig.metric}</p>
                <p className="text-xs text-copper font-mono mt-1">✓ {sig.proof}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="hidden md:flex flex-col w-full h-full relative justify-between max-w-5xl mx-auto px-8 lg:px-12 pt-16 lg:pt-18 pb-4">
        ...
        <div ref={desktopHeaderRef} className="text-center shrink-0 mt-2 mb-1">
          <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-surface border border-copper/25 shadow-2xs text-copper text-[11px] font-mono font-bold tracking-wider mb-1.5">
            ...
            <span>EVIDENCE-FIRST MATCHING</span>
          </div>
        ...
        <div className="relative w-full flex-1 flex flex-col justify-start items-center pt-3 lg:pt-5 min-h-[380px]">
          ...
          >
            ...
            {/* Payoff statement */}
            <div className="my-5 py-3 px-4 rounded-xl bg-sand/50 border border-copper/20">
              <p className="text-base font-bold text-ink tracking-tight font-display">
                3 signals. 1 relevant business.
              </p>
              <p className="text-xs text-slate mt-1 font-mono leading-relaxed">
                Product fit (95) · Capacity (88) · Certifications (92)
              </p>
            </div>
            ...
            <div className="flex items-center justify-between text-xs font-mono pt-2 border-t border-ink/[0.06]">
              ...
              <Link
                href="/discover"
                className="inline-flex items-center gap-1 text-copper hover:text-copper-muted font-bold transition-colors"
              >
        ...
        <div className="text-center shrink-0 pt-2 border-t border-ink/[0.04]">
          <p className="text-[10px] font-mono text-slate/60">
            SIMULATED MATCHING DEMONSTRATION · AUDITED AGAINST VERIFIED REGISTRIES &amp; CHAMBER DATA
          </p>
        </div>
      </div>
      ...
      <div className="flex md:hidden flex-col w-full h-full relative justify-between px-4 pt-16 pb-3 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center items-center w-full py-1">
          ...
          <div ref={mobileHeaderRef} className="text-center shrink-0 mb-3 w-full">
            ...
            <p className="mt-1 text-xs text-slate leading-snug max-w-[34ch] mx-auto">
              LINKSUPPLIED shows the signals behind the match.
            </p>
          </div>
            ...
            >
              ...
              <div className="my-3 py-2.5 px-3 rounded-xl bg-sand/50 border border-copper/20 text-center">
                <p className="text-xs font-bold text-ink font-display">
                  3 signals verified. 1 relevant business.
                </p>
                <div className="flex items-center justify-center gap-1.5 mt-1.5 flex-wrap">
                  <span className="px-2 py-0.5 rounded-md bg-surface border border-copper/20 text-[9px] font-mono text-copper font-semibold">
                    ✓ Product 95
                  </span>
                  <span className="px-2 py-0.5 rounded-md bg-surface border border-copper/20 text-[9px] font-mono text-copper font-semibold">
                    ✓ Capacity 88
              ...
              <Link
                href="/discover"
                className="inline-flex items-center justify-center gap-1.5 w-full py-2.5 rounded-xl bg-copper text-white text-xs font-mono font-bold tracking-wider hover:bg-copper-muted transition-colors shadow-sm"
              >
                Inspect business profile
              ...
              <p className="text-[9px] font-mono text-slate/60 mt-2">
                Audited against active Ministry &amp; Customs registries
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center shrink-0 pt-1 border-t border-ink/[0.04]">
          <p className="text-[9px] font-mono text-slate/60">
            SIMULATED DEMONSTRATION · BASED ON AUDITED REGISTRIES
          </p>
        </div>
      </div>
    </section>
